...
button.on("click", () => {
  ...
  if (response.filterData.length !== 0) {
    ...
    else if (response.filterData.length === 0 && ((response.filterCity.length !== 0 || response.filterDate.length !== 0 || response.filterState.length !== 0 || response.filterShape.length !== 0 ))){
